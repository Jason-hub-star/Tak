...
export const PROCESS_STEPS: ProcessStep[] = [
  ...
  },
  {
    step: 4,
    title: "납품",
    description: "플랫폼 규격에 맞춘 완성본과 운영 가이드를 함께 제공합니다.",
    deliverable: "완성본 + 운영 가이드",
    icon: "Package",
  },
];
...
export const FAQ_ITEMS: FAQItem[] = [
  ...
  {
    question: "완성 후 작업 원본(PSD/AI) 파일도 받을 수 있나요?",
    answer:
      "작업 원본 파일은 제공하지 않지만, 스마트스토어·오픈마켓에 바로 등록할 수 있는 완성 이미지와 운영 가이드를 함께 납품합니다. 기본 수정 2회가 포함되며, 이후 수정·업데이트는 케어 플랜으로 도와드립니다.",
  },
  {
