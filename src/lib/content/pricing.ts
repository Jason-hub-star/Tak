...
export const PRICING_PLANS: PricingPlan[] = [
  {
    ...
    price: "490,000원~",
    period: "/건",
    body: "제품의 장점을 정리해, 고객이 사고 싶어지는 흐름으로 설계합니다. 기획부터 촬영·카피·디자인까지 한 번에.",
    features: [
      "제품 및 타깃 분석",
      "상세페이지 기획·콘티 구성",
      "AI 기반 판매 문구·카피 제안",
  ...
  },
  {
    ...
    price: "990,000원~",
    period: "/건",
    body: "한 번의 촬영으로 상세페이지와 쇼츠를 함께. 검색에서 보고, 영상에서 관심 갖고, 상세페이지에서 구매로 연결합니다.",
    features: [
      "제품 및 경쟁사 분석",
      "판매 전략·콘텐츠 방향 기획",
      "제품 사진·영상 촬영",
...
export const PRICING_COMPARE = {
  eyebrow: "COMPARE",
  title: "제작 플랜 비교",
  columns: ["항목", "상세페이지", "상세 + 쇼츠", "브랜드 웹사이트", "풀패키지"],
  rows: [
    { label: "시작가 (부가세 별도)", values: ["490,000원~", "990,000원~", "990,000원~", "1,650,000원~"] },
    { label: "구성", values: ["상세페이지 1건", "상세 + 쇼츠 1편", "랜딩~다페이지", "상세 + 웹사이트"] },
    { label: "반응형 (PC/모바일)", values: ["—", "—", "✅", "✅"] },
    { label: "촬영 포함", values: ["✅", "✅", "옵션", "✅"] },
    { label: "쇼츠 영상 (15~30초)", values: ["—", "✅", "—", "옵션"] },
    { label: "문의폼 · 카톡 연동", values: ["—", "—", "✅", "✅"] },
    { label: "검색 등록 · SEO", values: ["—", "—", "기본", "최적화"] },
    { label: "광고 세팅 1회", values: ["—", "—", "옵션", "✅"] },
    { label: "추천 대상", values: ["단일 상품", "상세 + 영상 동시", "정식 브랜드 사이트", "런칭 풀세팅"] },
  ],
} as const;
